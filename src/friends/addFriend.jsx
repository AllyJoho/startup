...
function handleSubmit(e) {
    ...
    if (!recipient) {
    setMessage(`User not found. Existing users: ${users.map(u => u.username).join(', ')}`);
      return;
    }
    ...
    const updatedUsers = users.map(u =>
      u.username === recipient.username ? recipient : u
    );
  ...
  return (
    <div>
      <form onSubmit={handleSubmit}>
        ...
        />
        <button type="submit" className="btn btn-primary">Send Friend Request</button>
      </form>
